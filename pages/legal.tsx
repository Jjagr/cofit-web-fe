...
const Legal = () => {
  return (
    <NavOver>
      ...
      <div className="w-100 px-8 md:px-[100px]">
        <div className="header">
          <div className="container pt-[151px]">
            {/* <p className="title">Privacy Policy for Groofit</p> */}
          </div>
        </div>
        ...
        <div className="translations-content-container">
          <div className="container">
            <div
              ...
              id="en"
            >
              <h1 className="font-bold text-primary-700 text-mobileh1 md:text-h1 mb-[32px]">
                Privacy Policy
              </h1>
              ...
              <h1 className="font-bold text-primary-700 text-mobileh1 md:text-h1 mt-[32px] mb-[16px] md:mt-[64px] md:mb-[32px]">
                Interpretation and Definitions
              </h1>
              <h2 className="text-mobileh2 md:text-h2 font-bold mb-6 mt-8 text-primary-700">
                Interpretation
              </h2>
              <p>
              ...
              <ul>
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">Account</strong> means a unique account created for
                ...
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">Application</strong> means the software program
                    provided by the Company downloaded by You on any electronic
                    device, named Groofit
                  </p>
                </li>
                <li className="list-disc ml-6">
                  <p>
                ...
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">Country</strong> refers to: Indonesia
                  </p>
                </li>
                <li className="list-disc ml-6">
                  <p>
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Personal Data</h3>
              <p>
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Usage Data</h3>
              <p>
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Information Collected while Using the Application</h3>
              <p>
              ...
              <ul>
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">To provide and maintain our Service</strong>,
                ...
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">To provide You</strong> with news, special offers
                ...
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">To manage Your requests:</strong> To attend and
                ...
                <li className="list-disc ml-6">
                  <p>
                    <strong className="font-semibold">For other purposes</strong>: We may use Your
              ...
              <ul>
                ...
                <li className="list-disc ml-6">
                  <strong className="font-semibold">For business transfers:</strong> We may share or
                ...
                <li className="list-disc ml-6">
                  <strong className="font-semibold">With Affiliates:</strong> We may share Your
                ...
                <li className="list-disc ml-6">
                  <strong className="font-semibold">With Your consent</strong>: We may disclose Your
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Business Transactions</h3>
              <p>
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Law enforcement</h3>
              <p>
              ...
              <h3 className=" text-h4 font-semibold text-primary-700 my-4">Other legal requirements</h3>
              <p>
              ...
              <ul className="mb-[151px]">
                <li className="list-disc ml-6">
                  <p>By email: jjagrteam@gmail.com</p>
                </li>
                <li className="list-disc ml-6">
                  <p>
